...
const PanelDiscussion = [
  {
    ...
    paragraph: '<li>Sharing the past challenges and how companies overcome it. </li><li>Providing an overview of the challenges and the current state of blockchain in the selected verticals.</li><li>Underscoring the importance of collaboration across the different vendors.</li> '
  },
  {
    title: 'Future of blockchain, ethics, and governance: Moving beyond proof of concept',
    paragraph: '<li>Exploring how government, corporations and startups could work together and benefit on blockchain.</li><li>Providing insights on regulatory takes on various blockchain projects, e.g. ICO, STO, and financial related blockchain project.</li><li>Discussion on the sector that scores high on feasibility and viability of blockchain.</li>'
  },
  {
    title: 'Future proof yourself: Preparing for digital disruptions',
    paragraph: '<li>Conversation among IHL and corporations on future of work.</li><li>Sharing about the innovative technology and the current disruptions that are happening. This will not be limited to blockchain, it will also tap into the future of automation. </li>'
  }
]
    ...
    <h2 className="text-center">Overview</h2>
      <Tabs>
        ...
        <ReactTabsRow>
          ...
          <TabPanel>
            <h3 className="text-body">1-2 June 2019</h3>
            <Accordion data={ DayOneWs }/>
            <h3 className="text-body">8 June 2019</h3>
            <Accordion data={ DayTwoWs }/>
            <h3 className="text-body">15 June 2019</h3>
            <Accordion data={ DayThreeWs }/>
          </TabPanel>
          <TabPanel>
            <h3 className="text-body">15 June 2019: <span className="text-muted font-weight-light">Apply your agile knowledge to create your first pitch</span></h3>
          </TabPanel>
          <TabPanel>
            <h3 className="text-body">21, 22 June 2019: <span className="text-muted font-weight-light">National Blockchain Challenge</span></h3>
            <h3 className="text-body">23 June 2019: <span className="text-muted font-weight-light">Judging day + Panels + Career fair</span></h3>
