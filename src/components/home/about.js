...
const About = (props) => (
  <Panel className="bg-white" id="about">
    <div className="px-4 pb-5">
      ...
      <p className="pb-0 text-center">Blockchain is an emerging technology that is increasingly incorporated into enterprises due to its immutable, reliable and decentralised nature. Through the National Blockchain Challenge 2019, we are looking for ambitious student developers who want to design the future of work with us.</p>
      ...
      <div className="row align-items-center container__cstm--y">
        <div className="col-12 col-sm-7 pl-sm-0 order-1 order-sm-0">
          ...
          <h3 className="text-body">15 June</h3>
          <ul>
            <li>Preliminary hackathon: Prepare your slide decks</li>
          </ul>
          <h3 className="text-body">21-23 June</h3>
          <ul>
